package com.example.a503_16.a1024androidparsing;
...
public class MainActivity extends AppCompatActivity {
    ...
    class ThreadEx extends Thread{
        ...
        public void run(){
            try{
                String addr = "http://192.168.0.110:8080/1024androidservercopy/login?id=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //layout 파일을 읽어서 메모리에 로드 한 후 화면출력을 준비하는
        //메소드를 호출
        ...
        button.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                //진행 대화상자를 출력
                progressDialog =
                        ProgressDialog.show(MainActivity.this, "로그인", "로그인 처리 중");
